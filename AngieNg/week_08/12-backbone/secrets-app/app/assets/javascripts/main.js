var app = app || {};  // Create a global namespace (this is the way we group everything together and make everthing cleaner)
...
$(document).ready(function () {
  ...
  // This starts the router and make it listen for changes

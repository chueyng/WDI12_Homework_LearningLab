...
app.init = function () {
  // This keeps track of all objects we want to render and the lights we want to use
  ...
  // 4 parameters - field of view, screen ratio, how close to render things, how far to render things
  ...
  // Defines how the browser will see these elements, based on the camera angle. It also defines how it will do that behind the scenes
  // (WebGL, Canvas, CSS3D, SVG)
  ...
  var planeMaterial = new THREE.MeshLambertMaterial({
    color: 0xCFD8DC   //a hexadecial color
  });

  app.plane = new THREE.Mesh(planeGeometry, planeMaterial);     //The things that brings the material and the shape togeter

...
// Group the random words by starting letter when in lowercase
...
//Ex1
var sortPeople = _.sortBy(people, 'uid');

console.log("Sort the people: ", sortPeople);


//Ex2
var groupLetters = _.groupBy(words, function(word) {
  return _.first(word.toLowerCase());
});
console.log("Group Letter by starting lowercase = ", groupLetters);

//Ex3
var charLength = _.groupBy(words, function(word) {
...
console.log("More Than 20 characters = ", moreThan20);


//Ex5
var sortPeople = _.sortBy(people, 'uid');
var uidsArr = _.pluck(sortPeople, 'uid');
console.log("UidsArray : ",uidsArr); 


//Ex6
var maxUids = _.max(people, 'uid');
console.log("Highest uids = ", maxUids);
...
//Ex8 
var randomThreeNum = _.sample(numbers, 3);

console.log("Random Three Number : ", randomThreeNum);
